...
from src.config.config import TOKEN, validate_config, print_config_info, ADMIN_ID
from src.database import init_db, init_super_admin
...
async def main():
    ...
    try:
        ...
        logger.info("👑 Инициализация супер-администратора...")
        init_super_admin(ADMIN_ID)
        logger.info("✅ Супер-администратор инициализирован")
